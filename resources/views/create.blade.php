                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="/posts/create">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="border-2 border-gray-300 p-2 w-full @error('title') border-red-500 @enderror" name="title" id="title" value="{{ old('title') }}">
                            @error('title')
                        ...
                        <div class="flex p-1">
                            <button role="submit" class="p-3 bg-blue-500 text-white hover:bg-blue-400" required>Create</button>
                        </div>
                    </form>
                </div>
            </div>
